...
<head>
  ...
  <title>Register - Pengaduan Online Siswa</title>
        ...
        <div class="row gy-4">
          ...
          <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="200">
              <i class="bi bi-person-plus-fill"></i>
                <div>
                  <h3>Register</h3>
                  <p>Silahkan Register untuk membuat akun anda</p>
                </div>
            </div>
            <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="200">
            ...
            <div>
                <h3>login</h3>
                <p>Silahkan Tekan Tombol DiBawah Ini Untuk Masuk Ke Akun Anda</p>
          ...
          <div class="col-lg-7">
            <form action="/register/store" method="post" data-aos="fade-up" data-aos-delay="500">
             @csrf
            <div class="row gy-4">
